  ...
  private static Stream<Arguments> provideValidationCases() {
    return Stream.of(
        ...
        ValidationTestCase.success(
            ...
            "StvnOption[schema=ResolvedSchema[node=[271 132 125], constraints=StvnConstraints[minIncl=null, minExcl=null, maxIncl=null, maxExcl=null, regex=null, preserveIndent=false, equatable=true, comparable=true, explicitOverrides=[], filterIncl=null, filterExcl=null], aliasName=null, implicitUnionTag=null, sumTypeNode=null, underlyingSchema=null, localConstraints=null, enumSubset=null], value=Optional[StvnInteger[schema=ResolvedSchema[node=[389 355 348 271 132 125], constraints=StvnConstraints[minIncl=null, minExcl=null, maxIncl=null, maxExcl=null, regex=null, preserveIndent=false, equatable=true, comparable=true, explicitOverrides=[], filterIncl=null, filterExcl=null], aliasName=null, implicitUnionTag=0, sumTypeNode=[355 348 271 132 125], underlyingSchema=null, localConstraints=null, enumSubset=null], value=42, bitWidth=32, isUnsigned=false]]]"
        ),
        ValidationTestCase.success(
            "Implied Either - Scalar Right Implied Route",
            "{ :type :Either(:Int :String) :body \"right-value\" }",
            "StvnEither[schema=ResolvedSchema[node=[271 132 125], constraints=StvnConstraints[minIncl=null, minExcl=null, maxIncl=null, maxExcl=null, regex=null, preserveIndent=false, equatable=true, comparable=true, explicitOverrides=[], filterIncl=null, filterExcl=null], aliasName=null, implicitUnionTag=null, sumTypeNode=null, underlyingSchema=null, localConstraints=null, enumSubset=null], value=StvnString[schema=ResolvedSchema[node=[397 355 348 271 132 125], constraints=StvnConstraints[minIncl=null, minExcl=null, maxIncl=null, maxExcl=null, regex=null, preserveIndent=false, equatable=true, comparable=true, explicitOverrides=[], filterIncl=null, filterExcl=null], aliasName=null, implicitUnionTag=1, sumTypeNode=[355 348 271 132 125], underlyingSchema=null, localConstraints=null, enumSubset=null], value=right-value, style=SIMPLE, fenceTag=Optional.empty, trait=StringTrait[fixedLength=0, maxLength=0, isNonEmpty=false]], isRight=true, isAmbiguous=false]"
        ),
        ...
        ValidationTestCase.success(
            ...
            "StvnEither[schema=ResolvedSchema[node=[271 132 125], constraints=StvnConstraints[minIncl=null, minExcl=null, maxIncl=null, maxExcl=null, regex=null, preserveIndent=false, equatable=true, comparable=true, explicitOverrides=[], filterIncl=null, filterExcl=null], aliasName=null, implicitUnionTag=null, sumTypeNode=null, underlyingSchema=null, localConstraints=null, enumSubset=null], value=StvnInteger[schema=ResolvedSchema[node=[396 355 348 271 132 125], constraints=StvnConstraints[minIncl=null, minExcl=null, maxIncl=null, maxExcl=null, regex=null, preserveIndent=false, equatable=true, comparable=true, explicitOverrides=[], filterIncl=null, filterExcl=null], aliasName=null, implicitUnionTag=null, sumTypeNode=null, underlyingSchema=null, localConstraints=null, enumSubset=null], value=42, bitWidth=32, isUnsigned=false], isRight=false, isAmbiguous=false]"
        ),
        ValidationTestCase.success(
        ...
        ValidationTestCase.success(
            ...
            "StvnOption[schema=ResolvedSchema[node=[271 132 125], constraints=StvnConstraints[minIncl=null, minExcl=null, maxIncl=null, maxExcl=null, regex=null, preserveIndent=false, equatable=true, comparable=true, explicitOverrides=[], filterIncl=null, filterExcl=null], aliasName=null, implicitUnionTag=null, sumTypeNode=null, underlyingSchema=null, localConstraints=null, enumSubset=null], value=Optional[StvnEither[schema=ResolvedSchema[node=[389 355 348 271 132 125], constraints=StvnConstraints[minIncl=null, minExcl=null, maxIncl=null, maxExcl=null, regex=null, preserveIndent=false, equatable=true, comparable=true, explicitOverrides=[], filterIncl=null, filterExcl=null], aliasName=null, implicitUnionTag=null, sumTypeNode=null, underlyingSchema=null, localConstraints=null, enumSubset=null], value=StvnString[schema=ResolvedSchema[node=[397 355 348 389 355 348 271 132 125], constraints=StvnConstraints[minIncl=null, minExcl=null, maxIncl=null, maxExcl=null, regex=null, preserveIndent=false, equatable=true, comparable=true, explicitOverrides=[], filterIncl=null, filterExcl=null], aliasName=null, implicitUnionTag=1, sumTypeNode=[355 348 389 355 348 271 132 125], underlyingSchema=null, localConstraints=null, enumSubset=null], value=nested-implicit-right, style=SIMPLE, fenceTag=Optional.empty, trait=StringTrait[fixedLength=0, maxLength=0, isNonEmpty=false]], isRight=true, isAmbiguous=false]]]"
        ),
        ValidationTestCase.success(
            "Hybrid Nested Tagging - Explicit Either Implicit Option Some",
            "{ :type :Either(:Int :Option(:String)) :body #Right \"implicit-inner-some\" }",
            "StvnEither[schema=ResolvedSchema[node=[271 132 125], constraints=StvnConstraints[minIncl=null, minExcl=null, maxIncl=null, maxExcl=null, regex=null, preserveIndent=false, equatable=true, comparable=true, explicitOverrides=[], filterIncl=null, filterExcl=null], aliasName=null, implicitUnionTag=null, sumTypeNode=null, underlyingSchema=null, localConstraints=null, enumSubset=null], value=StvnOption[schema=ResolvedSchema[node=[397 355 348 271 132 125], constraints=StvnConstraints[minIncl=null, minExcl=null, maxIncl=null, maxExcl=null, regex=null, preserveIndent=false, equatable=true, comparable=true, explicitOverrides=[], filterIncl=null, filterExcl=null], aliasName=null, implicitUnionTag=null, sumTypeNode=null, underlyingSchema=null, localConstraints=null, enumSubset=null], value=Optional[StvnString[schema=ResolvedSchema[node=[389 355 348 397 355 348 271 132 125], constraints=StvnConstraints[minIncl=null, minExcl=null, maxIncl=null, maxExcl=null, regex=null, preserveIndent=false, equatable=true, comparable=true, explicitOverrides=[], filterIncl=null, filterExcl=null], aliasName=null, implicitUnionTag=0, sumTypeNode=[355 348 397 355 348 271 132 125], underlyingSchema=null, localConstraints=null, enumSubset=null], value=implicit-inner-some, style=SIMPLE, fenceTag=Optional.empty, trait=StringTrait[fixedLength=0, maxLength=0, isNonEmpty=false]]]], isRight=true, isAmbiguous=false]"
        ),
        ValidationTestCase.failure(
